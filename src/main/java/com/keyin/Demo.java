 ...
 */
public class Demo {
    //Method to add a library item to the database
    //Method to remove item from database
    /**
     * Method to add a LibraryItem, Patron, or Author object
     * @param l accepts Library object to obtain lists
     */
    public static void addBook(Library l){
        ...
        if(itemChoice.equals("LB")){
            while(!validInput){
                System.out.println("Is the library Item a book or periodical(B, P): ");
            ...
            if(itemType.equals("B") ){
                ...
                //Input whether the author is in the system or not
                while(!validInput){
                    System.out.println("Is the author of the library item already in the system?(Y,N)?");
                    choice = scanner.next();
                ...
                if(choice.equals("N")){
                    ...
                    //Create the object and add it to the system
        ...
        if(itemChoice.equals("P")){
            ...
            if(pType.equals("S")){
                ...
                //Create a student object with the inputted data
                Student s = new Student(pId,name,address,phoneNum,studentID, school, grade);
                l.addPatron(s);

            }

            //Enter if the patron is an Employee
...
//Method to remove item from database
    /**
     * Method to remove a LibraryItem, Patron, or Author object
     * @param l accepts Library object to obtain lists
     */
//Method to remove item from database
    public static void removeItem(Library l){
        ...
        if(choice.equals("LB")){
            ...
            if(itemType.equals("B")){
                ...
                //Search through the books with the title
        ...
        //Enter if a patron is being deleted
            ...
            if (!valid){
                ...
                validInput = true;
                ArrayList<LibraryItem> lbList = removePar.getBorrowedList();

                //Return the patrons books
                for(LibraryItem i: lbList){
                    i.Return();
                }
    ...
    /**
     * Method to edit a LibraryItem, Patron, or Author object
     * @param l accepts Library object to obtain lists
     */
    //Method to edit item
    public static void editItem(Library l){
        ...
        //Enter if a library item is being edited
        if(iType.equals("LB")){
            while(!validInput){
                System.out.println("Enter the type of Item(B,P)");
                itemType = scanner.next();
            ...
            if(itemType.equals("B")){
                ...
                //Enter if it could not find the book
                if(!valid){
                    System.out.println("Book does not exist");
                }
            }
            //Enter if a periodical is being edited
                ...
                //Enter if it could not find periodical
                if(!valid){
                    System.out.println("Periodical does not exist");
                }
            }
        ...
        //Enter if the user wants to edit a patron
            ...
            //Enter if it could not find patron
            if(!valid){
        ...
        //Enter if an author is being edited
            ...
            //Enter if it could not find author
            if(!valid){
    ...
    /**
     * Method to search through LibraryItem Objects to borrow a LibraryItem object
     * @param l accepts Library object to obtain lists
     */
    ...
    public static void borrowItem(Library l){
        ...
        if(type.equals("T")){
            ...
            while(!validInput){
                System.out.println("Enter the name of the type of publication that is being borrowed(B,P)");
            ...
            if(pubType.equals("B")){
                ...
                for(Book b: bList){
                    ...
                    if(title.equals(b.getTitle())){
                        ...
                        //Enter if it could not find book
            ...
            //Enter if the item is a periodical
                ...
                //Search the database for the periodical
                for(Periodical p: pList){
        ...
        //Enter if searching by the Author
        if(type.equals("A")){
            String authorName;
            System.out.println("Enter the name of the Author");
            authorName = scanner.next();
            ArrayList <LibraryItem> aBookList = new ArrayList<LibraryItem>();
    ...
    /**
     * Method to return a LibraryItem Object
     * @param l accepts Library object to obtain lists
     */
    ...
    public static void returnLibraryItem(Library l){
        ...
        for(Patron par: parList){
            //Search the system for the inputted id
            if(par.getPatronID() == parId){
                String title;
                ArrayList<LibraryItem> itemList = par.getBorrowedList();
                ...
                //Obtain how many of the item the user has borrowed
                for(LibraryItem i : itemList){
                ...
                if(removeBook){
                    ...
                    while(!validAmount){
                        ...
                        //Enter if the user has inputted a value greater than the amount they have borrowed
    ...
    public static void main(String[] args) {
        ...
        Author a3 = new Author("JohnIgor", "1987/11/13");
        ...
        Patron pa2 = new Employee(235, "DavePenny", "56AlexisLane", "0987654321", 3786, "Management" );
