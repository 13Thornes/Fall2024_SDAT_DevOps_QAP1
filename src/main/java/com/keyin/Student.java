...
public class Student extends Patron{
    ...
    /**
     * represents the school of the student
     */
     ...
     * @param phoneNum accepts phoneNum and set it to the Student object
     ...
     */
    public Student(int patronID, String name, String address, String phoneNum, int studentID, String school, int grade, ArrayList<LibraryItem> itemList) {
        super(patronID, name, address, phoneNum);
        this.studentID = studentID;
        this.school = school;
        this.grade = grade;
        ArrayList<LibraryItem> borrowList = new ArrayList<LibraryItem>();
